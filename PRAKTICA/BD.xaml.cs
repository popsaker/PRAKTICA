...
namespace Example
{
    internal class DbService
    {
        ...
        public static string connectionString = "server=tompsons.beget.tech;user=tompsons_stud13;database=tompsons_stud13;password=BJiETL0a17;CharSet=utf8mb4;";
        ...
        public static Autorize AuthenticateUser(string login, string password)
        {
            try
            {
                string query = "SELECT * FROM autoreze WHERE login = @login AND password = @password";
